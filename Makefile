...
load-test-signup:
	...
	@locust -f load_tests/endpoints/signup.py --host=http://127.0.0.1:8080 --web-host=127.0.0.1

load-test-login:
	@echo "Starting Locust UI for LoginUserTest..."
	@locust -f load_tests/endpoints/login.py --host=http://127.0.0.1:8080 --web-host=127.0.0.1

load-test-view-current:
	@echo "Starting Locust UI for ViewCurrentUserTest..."
	@locust -f load_tests/endpoints/view_current_user.py --host=http://127.0.0.1:8080 --web-host=127.0.0.1

load-test-view-all:
	@echo "Starting Locust UI for ViewAllUsersTest..."
	@locust -f load_tests/endpoints/view_all_users.py --host=http://127.0.0.1:8080 --web-host=127.0.0.1

load-test-update:
	@echo "Starting Locust UI for UpdateUserDataTest..."
	@locust -f load_tests/endpoints/update_user_data.py --host=http://127.0.0.1:8080 --web-host=127.0.0.1

load-test-delete:
	@echo "Starting Locust UI for DeleteUserDataTest..."
	@locust -f load_tests/endpoints/delete_user_data.py --host=http://127.0.0.1:8080 --web-host=127.0.0.1

load-test-logout:
	@echo "Starting Locust UI for LogoutUserTest..."
	@locust -f load_tests/endpoints/logout.py --host=http://127.0.0.1:8080 --web-host=127.0.0.1
